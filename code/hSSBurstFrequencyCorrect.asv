...
function [rxWaveform, freqOffset, NID2] = hSSBurstFrequencyCorrect(rxWaveform,scs,rxSampleRate,searchBW)
    ...
    for fIdx = 1:numel(fshifts)
        ...
        % Downsample to the minimum sampling rate to cover SSB bandwidth
